...
public class PlayingCardTest_Vegas {
	...
	String deckSortedBySuit[] = {"Jack Club","Queen Club","King Club","Ace Club","Two Club","Three Club","Four Club",
			...
			,"Jack Spade", "Queen Spade", "King Spade","Ace Spade","Two Spade",
	...
	public void setup()
	{
		vegasDeck = deckFactory.createDeckFactory(deckType,3);	
