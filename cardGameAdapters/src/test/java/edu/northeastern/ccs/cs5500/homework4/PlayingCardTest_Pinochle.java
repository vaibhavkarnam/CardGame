...
public class PlayingCardTest_Pinochle {
		...
		String deckSortedBySuit[] = {
				"Jack Club","Queen Club","King Club","Ace Club","Nine Club","Ten Club",
				...
				"Ten Spade","Jack Spade", "Queen Spade", "King Spade","Ace Spade","Nine Spade","Ten Spade"};
