...
import problem1.EuchreDeckImpl;
...
public class PlayingCardTest_Euchre {
	...
	String deckSortedByBothSuitAndRank[] = {"Ace Spade","Nine Spade","Ten Spade","Jack Spade", "Queen Spade",
			"King Spade","Ace Club","Nine Club","Ten Club","Jack Club","Queen Club","King Club","Ace Diamond",
			"Nine Diamond","Ten Diamond","Jack Diamond","Queen Diamond","King Diamond","Ace Heart",
			"Nine Heart","Ten Heart","Jack Heart","Queen Heart","King Heart"};
	
	/** The deck sorted by suit. */
	String deckSortedBySuit[] = {"Jack Spade", "Queen Spade", "King Spade","Ace Spade","Nine Spade",
			"Ten Spade","Jack Club","Queen Club","King Club","Ace Club","Nine Club","Ten Club","Jack Diamond",
