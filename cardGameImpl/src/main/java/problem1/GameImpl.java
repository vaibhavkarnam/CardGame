...
public class GameImpl implements Game{
	...
	
	{
		...
		{
			deck = new PinochleDeckImpl();
		}
		else if(deckType.equals("Vegas"))
		{
			deck = new VegasDeckImpl();
		}
	}
	...
	public void createDeck(String deckType, int numberOfDecks)
	{
		...
		if(deckType.equals("Standard"))
		{
			 deck = new StandardDeckImpl(numberOfDecks);
		}
		else if(deckType.equals("Euchre"))
		{
			deck = new EuchreDeckImpl(numberOfDecks);
		}
		else if(deckType.equals("Pinochle"))
		{
			deck = new PinochleDeckImpl(numberOfDecks);
		}
		else if(deckType.equals("Vegas"))
		{
			deck = new VegasDeckImpl(numberOfDecks);
		}
	}
